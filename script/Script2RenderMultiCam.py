...
for camera in cameras : 
    ...
    bpy.context.scene.render.filepath = outputPath + camera.name
    ...
    numpy.savetxt(outputPath+camera.name+'_intrinsic.txt', numpy.matrix(K))
    print('intrinsic parameter saved')
    print(K)
    numpy.savetxt(outputPath+camera.name+'_extrinsic.txt', numpy.matrix(RT))
